...
def upload_to_r2(image_bytes: bytes, filename: str, card_id: str) -> str:
    """Faz upload para Cloudflare R2. Retorna '' se R2 não estiver configurado."""
    ...
    client.put_object(Bucket=settings.r2_bucket, Key=key, Body=image_bytes, ContentType=content_type)
